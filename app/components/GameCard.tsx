  ...
  <div className="flex gap-4 min-w-0 flex-1">
    {game.imageUrl && (
      <img
        src={game.imageUrl}
        alt={game.name}
        className="w-[180px] h-[84px] object-cover rounded-lg border border-[#2a475e] shrink-0"
      />
    )}

    <div className="flex-1 min-w-0">
      <div className="flex items-center gap-2 mb-2 flex-wrap">
        <h3 className="text-base font-bold text-[#c7d5e0] truncate">
          {game.name}
        </h3>
